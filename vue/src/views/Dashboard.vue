      ...
      >
        ...
        <div class="row-span-2 order-3 lg:order-1 bg-white shadow-md p-4 animate-fade-in-down">
          ...
          <div class="flex justify-between text-sm mb-1">
            ...
            <div>{{ data.latestSurvey.expired_date }}</div>
          </div>
          <div class="flex justify-between text-sm mb-1">
            <div>Status:</div>
        ...
        <div class="bg-white shadow-md p-3 row-span-2 order-4 lg:order-3 animate-fade-in-down" style="animation-delay: 0.3s;">
          ...
          <a 
            href="#"
            v-for="answers of data.latestAnswers"
            :key="answers.id"
            class="block p-2 hover:bg-gray-100/90 text-start"
          >
            <div class="font-semibold">{{ answers.survey.title }}</div>
            <small>
              Answers Made at:
              <i class="font-semibold">{{ answers.end_date }}</i>
            </small>
          </a>
        </div>
      </div>
